...
if __name__ == '__main__':
    ...
    try:
        model = tf.keras.models.load_model('rlce_decoder_model_15.keras')
    except Exception as e:
        print(f"ERROR: Could not load 'rlce_decoder_model_15.keras'. Make sure you have run the training script first.")
        print(f"Details: {e}")
        exit()

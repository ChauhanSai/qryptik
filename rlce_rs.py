...
class rlce_rs:
    def __init__(self, n, k, t, r):
        ...
        self.Gs = self.rs_code.G #reed-solomon generator matrix
        self.G1 = self._generate_G1() #inserting r random columns
        self.A = self._generate_A() #block diagonal matrix of random matrices
        self.S = self._generate_random_non_singular_matrix(k) #random non-singular matrix
        self.P = self.GF(self._generate_random_permutation_matrix(n*(r+1))) #random permutation matrix
